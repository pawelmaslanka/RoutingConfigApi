/** @brief The content taken from file multiinherit_shared.cc of <a href="https://gist.github.com/zhangyuchi/973f39d02460f3b597bd">zhangyuchi's github repo</a>
*/
#pragma once
...
template <class T>
using InheritableEnableSharedFromThis =  inheritable_enable_shared_from_this<T>;
